...
#SBATCH --job-name=gdn+attn_3-1-main_n-50M_gbs-16_lr-all_parallel
...
CONFIG=/projects/p_neurasearch/alphafastlm/execs/gdn+attn_3-1/50M/cfg-main_gbs-16_lr-all_parallel.yaml
DP=1
HOST=$(hostname -f)
