...
#SBATCH --job-name=gdn+attn_3-1-decay_n-150M_gbs-16_lr-all_parallel
...
CONFIG=/projects/p_neurasearch/fastlm/execs/gdn+attn_3-1/150M/cfg-decay_gbs-16_lr-all_parallel.yaml
DP=1
HOST=$(hostname -f)
