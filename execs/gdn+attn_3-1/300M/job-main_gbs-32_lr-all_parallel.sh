...
#SBATCH --job-name=gdn+attn_3-1-main_n-300M_gbs-32_lr-all_parallel
...
CONFIG=/projects/p_neurasearch/fastlm/execs/gdn+attn_3-1/300M/cfg-main_gbs-32_lr-all_parallel.yaml
DP=1
HOST=$(hostname -f)
