...
#SBATCH --job-name=gdn+attn_3-1-main_n-20M_gbs-16_lr-1lrs
...
CONFIG=/projects/p_neurasearch/alphafastlm/execs/gdn+attn_3-1/20M/cfg-main_gbs-16_lr-all_parallel.yaml
DP=1
HOST=$(hostname -f)
