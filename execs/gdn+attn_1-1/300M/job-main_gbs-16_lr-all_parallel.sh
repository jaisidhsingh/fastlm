...
#SBATCH --job-name=gdn+attn_1-1-main_n-300M_gbs-16_lr-all_parallel
...
CONFIG=/projects/p_neurasearch/fastlm/execs/gdn+attn_1-1/300M/cfg-main_gbs-16_lr-all_parallel.yaml
DP=1
HOST=$(hostname -f)
